...
const KcalBox = ({ tab }: Props) => {
  return (
    <div className="rounded-2xl border border-white/20 bg-white/90 p-6 text-center shadow-lg backdrop-blur-sm">
      ...
      <div className="mb-2 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-4xl font-bold text-transparent">
        1,150<span className="ml-2 text-xl text-gray-500">kcal</span>
      </div>
