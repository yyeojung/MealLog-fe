    ...
    <>
      ...
      {items.length === 0 && (
        <Link
          ...
          className="block w-full rounded-xl border border-white/20 bg-white/90 p-4 text-center text-gray-600 shadow-md backdrop-blur-sm transition-all duration-200 hover:scale-105"
        >
          식사를 추가해보세요
        </Link>
      )}
